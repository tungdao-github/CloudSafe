function generateAnalysisChartData() {
  ...
  const salesTypeData = [
    { x: 'PDF/Tài liệu', y: 4544 },
    { x: 'Excel/Bảng tính', y: 3321 },
    { x: 'Word/Văn bản', y: 3113 },
    { x: 'Hình ảnh', y: 2341 },
    { x: 'Archive/ZIP', y: 1231 },
    { x: 'Khác', y: 1231 },
  ];

  const salesTypeDataOnline = [
    { x: 'PDF/Tài liệu', y: 244 },
    { x: 'Excel/Bảng tính', y: 321 },
    { x: 'Word/Văn bản', y: 311 },
    { x: 'Hình ảnh', y: 41 },
    { x: 'Archive/ZIP', y: 121 },
    { x: 'Khác', y: 111 },
  ];
  ...
  const salesTypeDataOffline = [
    { x: 'PDF/Tài liệu', y: 99 },
    { x: 'Excel/Bảng tính', y: 188 },
    { x: 'Word/Văn bản', y: 344 },
    { x: 'Hình ảnh', y: 255 },
    { x: 'Khác', y: 65 },
  ];
